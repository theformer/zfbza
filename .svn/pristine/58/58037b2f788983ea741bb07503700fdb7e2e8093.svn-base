...
export default class Slider extends Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      left: sliderBlock.offsetLeft + sliderLine.offsetWidth / (this.props.max - this.props.min) * this.props.step * (this.state.value - this.props.min),
  ...
  touchEnd(e) {
    this.props.bindEnd && this.props.bindEnd(this.state.value)
  }
  render() {
